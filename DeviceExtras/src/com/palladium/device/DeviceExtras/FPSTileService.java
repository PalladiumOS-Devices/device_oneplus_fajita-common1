...
public class FPSTileService extends TileService {
  ...
  public void onStartListening() {
      ...
      for (ActivityManager.RunningServiceInfo service :
          ...
          if (com.palladium.device.DeviceExtras.FPSInfoService.class.getName().equals(
  ...
  @Override
  public void onClick() {
      Intent fpsinfo = new Intent(this, com.palladium.device.DeviceExtras.FPSInfoService.class);
      if (!isShowing)
